...
export const CAMPAIGN_LEVELS_PER_TIER = 4;
export const CAMPAIGN_REWARD_LEVELS_BETWEEN_TIERS = 3;
...
export const CAMPAIGN_BIOMES = {
  ...
  mire: {
    ...
    weather: {
      ...
      fallSpeed: [0.4, 2.4],
      radius: [0.9, 1.8],
      driftAmplitude: [30, 88],
      driftSpeed: [0.05, 0.22],
      spawnGapRatio: [0, 0.2],
    },
  },
  clockwork: {
...
export const CAMPAIGN_TIERS: readonly CampaignTierDefinition[] = [
  {
    ...
    unlock: { level: 1 },
    milestones: [
      { id: "campaign-v2-level-2-coins", level: 2, reward: { kind: "coins", amount: 20 } },
      { id: "campaign-v2-level-3-coins", legacyIds: ["forest-level-2-coins"], level: 3, reward: { kind: "coins", amount: 25 } },
      { id: "campaign-v2-level-4-coins", legacyIds: ["forest-level-3-coins"], level: 4, reward: { kind: "coins", amount: 35 } },
    ],
  ...
  },
  {
    ...
    milestones: [
      { id: "campaign-v2-level-6-coins", level: 6, reward: { kind: "coins", amount: 45 } },
      { id: "campaign-v2-level-7-coins", legacyIds: ["snowy-level-5-coins"], level: 7, reward: { kind: "coins", amount: 55 } },
      { id: "campaign-v2-level-8-coins", legacyIds: ["snowy-level-6-coins"], level: 8, reward: { kind: "coins", amount: 65 } },
    ],
  ...
  },
  {
    ...
    milestones: [
      { id: "campaign-v2-level-10-coins", level: 10, reward: { kind: "coins", amount: 75 } },
      { id: "campaign-v2-level-11-coins", legacyIds: ["desert-level-8-coins"], level: 11, reward: { kind: "coins", amount: 90 } },
      { id: "campaign-v2-level-12-coins", legacyIds: ["desert-level-9-coins"], level: 12, reward: { kind: "coins", amount: 105 } },
    ],
  ...
  },
  {
    ...
    milestones: [
      { id: "campaign-v2-level-14-coins", level: 14, reward: { kind: "coins", amount: 120 } },
      { id: "campaign-v2-level-15-coins", legacyIds: ["wasteland-level-11-coins", "volcanic-level-11-coins"], level: 15, reward: { kind: "coins", amount: 135 } },
      { id: "campaign-v2-level-16-coins", legacyIds: ["wasteland-level-12-coins", "volcanic-level-12-coins"], level: 16, reward: { kind: "coins", amount: 155 } },
    ],
  ...
  },
  {
    ...
    milestones: [
      { id: "campaign-v2-level-18-coins", level: 18, reward: { kind: "coins", amount: 175 } },
      { id: "campaign-v2-level-19-coins", legacyIds: ["volcanic-level-14-coins", "wasteland-level-14-coins"], level: 19, reward: { kind: "coins", amount: 195 } },
      { id: "campaign-v2-level-20-coins", legacyIds: ["volcanic-level-15-coins", "wasteland-level-15-coins"], level: 20, reward: { kind: "coins", amount: 220 } },
    ],
  ...
  },
  {
    ...
    milestones: [
      { id: "campaign-v2-level-22-coins", level: 22, reward: { kind: "coins", amount: 250 } },
      { id: "campaign-v2-level-23-coins", legacyIds: ["rift-level-17-coins"], level: 23, reward: { kind: "coins", amount: 275 } },
      { id: "campaign-v2-level-24-coins", legacyIds: ["rift-level-18-coins"], level: 24, reward: { kind: "coins", amount: 305 } },
    ],
  ...
  },
  {
    ...
    milestones: [
      { id: "campaign-v2-level-26-coins", level: 26, reward: { kind: "coins", amount: 345 } },
      { id: "campaign-v2-level-27-coins", legacyIds: ["mire-level-20-coins"], level: 27, reward: { kind: "coins", amount: 375 } },
      { id: "campaign-v2-level-28-coins", legacyIds: ["mire-level-21-coins"], level: 28, reward: { kind: "coins", amount: 410 } },
    ],
