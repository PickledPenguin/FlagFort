...
export const ENEMY_REGISTRY: Record<EnemyKind, EnemyDefinition> = {
  ...
  frostbite: enemy({ id: "frostbite", displayName: "Frostbite", description: "A night-three ice skater that circles obstacles at unnerving speed.", tell: "Icy claws and a blue trail", tier: 3, introductionNight: 3, selectionWeight: 1, spawnWeight: 13, threat: 1.9, xp: 2, base: { health: 54, speed: 150, damage: 7, structureDamage: 7, attackRate: 0.88, radius: 21 }, caps: { perWave: 9, simultaneous: 7 }, assets: { portrait: "enemies/frostbite-zombie", body: "enemies/frostbite-zombie", hand: "enemies/frostbite-zombie" }, render: { aspectRatio: 1, height: 68, width: 68 }, audio: { attack: "zombie-attack", death: "zombie-death" }, targeting: { mode: "standard", detectionRadius: 350, attackRange: 0, lockSeconds: 0.62 }, movement: { avoidStructures: true, obstacleFallback: true, preferredRange: 0, meleeSpikes: true }, attack: { mode: "melee", chargeSeconds: 0.25 }, death: { mode: "none" }, rosterEligible: true, campaignTierIds: ["snowy"], countsForKills: true }),
  snowballer: enemy({ id: "snowballer", displayName: "Snowballer", description: "A night-five ranged attacker that hurls packed ice at turrets and defenders.", tell: "Raised snowball and wool cap", tier: 5, introductionNight: 5, selectionWeight: 1, spawnWeight: 8, threat: 3, xp: 3, base: { health: 52, speed: 88, damage: 9, structureDamage: 11, attackRate: 1.7, radius: 24 }, caps: { perWave: 7, simultaneous: 5 }, assets: { portrait: "enemies/snowballer-zombie", body: "enemies/snowballer-zombie", hand: "enemies/snowballer-zombie" }, render: { aspectRatio: 1, height: 74, width: 74 }, audio: { projectile: "archer-bow-fire", impact: "archer-arrow-impact", death: "zombie-death" }, targeting: { mode: "archer", detectionRadius: 590, attackRange: 430, lockSeconds: 1 }, movement: { avoidStructures: true, obstacleFallback: true, preferredRange: 350, meleeSpikes: false }, attack: { mode: "arrow", chargeSeconds: 1.05 }, projectile: { owner: "enemy-arrow", damageSource: "enemy-arrow", speed: 610, range: 620, lifetime: 1.45, radius: 7, width: 12, pierces: false, targets: ["turret", "player", "flag"], color: "#dff8ff" }, death: { mode: "none" }, rosterEligible: true, campaignTierIds: ["snowy"], countsForKills: true }),
  icebound: enemy({ id: "icebound", displayName: "Icebound Crusher", description: "A night-seven frozen brute whose thick shell absorbs sustained fire.", tell: "Cracked ice armor", tier: 7, introductionNight: 7, selectionWeight: 1, spawnWeight: 5, threat: 5, xp: 6, base: { health: 175, speed: 64, damage: 12, structureDamage: 22, attackRate: 1.55, radius: 35 }, caps: { perWave: 5, simultaneous: 3 }, assets: { portrait: "enemies/icebound-zombie", body: "enemies/icebound-zombie", hand: "enemies/icebound-zombie" }, render: { aspectRatio: 1, height: 92, width: 92 }, audio: { attack: "breaker-smash", death: "zombie-death" }, targeting: { mode: "standard", detectionRadius: 350, attackRange: 0, lockSeconds: 1 }, movement: { avoidStructures: false, obstacleFallback: true, preferredRange: 0, meleeSpikes: true }, attack: { mode: "melee", chargeSeconds: 0.38 }, death: { mode: "none" }, rosterEligible: true, campaignTierIds: ["snowy"], countsForKills: true }),
  ...
  "frost-warden": enemy({ id: "frost-warden", displayName: "Frost Warden", description: "The Snowbound Keep boss. It slams the fort and spits shards of killing ice.", tell: "Crown of ice and ten frozen segments", tier: 10, introductionNight: 10, selectionWeight: 0, spawnWeight: 0, threat: 42, xp: 24, base: { health: 1380, speed: 50, damage: 20, structureDamage: 38, attackRate: 1.9, radius: 68 }, caps: { perWave: 1, simultaneous: 1 }, assets: { portrait: "enemies/frost-warden", body: "enemies/frost-warden", hand: "gameplay/enemies/basic/hand" }, audio: { attack: "zombie-attack", projectile: "boss-acid-spit", death: "boss-death" }, targeting: { mode: "flag", detectionRadius: 9999, attackRange: 0, lockSeconds: 99 }, movement: { avoidStructures: false, obstacleFallback: true, preferredRange: 0, meleeSpikes: true }, attack: { mode: "boss", chargeSeconds: 0.294 }, death: { mode: "none" }, rosterEligible: false, campaignTierIds: ["snowy"], countsForKills: true }),
};
