...
export const ENEMY_REGISTRY: Record<EnemyKind, EnemyDefinition> = {
  ...
  frostbite: enemy({ id: "frostbite", displayName: "Frostbiter", description: "A swift ice skater whose chilling strikes slow defenders.", tell: "Icy claws and a blue trail", tier: 3, introductionNight: 3, selectionWeight: 1, spawnWeight: 13, threat: 1.9, xp: 2, base: { health: 54, speed: 150, damage: 7, structureDamage: 7, attackRate: 0.88, radius: 21 }, caps: { perWave: 9, simultaneous: 7 }, assets: { portrait: "enemies/frostbite-zombie", body: "enemies/frostbite-zombie", hand: "enemies/frostbite-zombie" }, render: { aspectRatio: 1, height: 68, width: 68 }, audio: { attack: "zombie-attack", death: "zombie-death" }, targeting: { mode: "standard", detectionRadius: 350, attackRange: 0, lockSeconds: 0.62 }, movement: { avoidStructures: true, obstacleFallback: true, preferredRange: 0, meleeSpikes: true }, attack: { mode: "melee", chargeSeconds: 0.25 }, death: { mode: "none" }, rosterEligible: true, campaignTierIds: ["snowy"], countsForKills: true }),
