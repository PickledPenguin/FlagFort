...
export const ENEMY_REGISTRY: Record<EnemyKind, EnemyDefinition> = {
  ...
  icebound: enemy({ id: "icebound", displayName: "Icebound Crusher", description: "A night-seven frozen brute whose thick shell absorbs sustained fire.", tell: "Cracked ice armor", tier: 7, introductionNight: 7, selectionWeight: 1, spawnWeight: 5, threat: 5, xp: 6, base: { health: 175, speed: 64, damage: 12, structureDamage: 22, attackRate: 1.55, radius: 35 }, caps: { perWave: 5, simultaneous: 3 }, assets: { portrait: "enemies/icebound-zombie", body: "enemies/icebound-zombie", hand: "enemies/icebound-zombie" }, render: { aspectRatio: 1, height: 98, width: 98 }, audio: { attack: "breaker-smash", death: "zombie-death" }, targeting: { mode: "standard", detectionRadius: 350, attackRange: 0, lockSeconds: 1 }, movement: { avoidStructures: false, obstacleFallback: true, preferredRange: 0, meleeSpikes: true }, attack: { mode: "melee", chargeSeconds: 0.38 }, death: { mode: "none" }, rosterEligible: true, campaignTierIds: ["snowy"], countsForKills: true }),
  ...
  "frost-warden": enemy({ id: "frost-warden", displayName: "Frost Warden", description: "The Snowbound Keep boss. Break its ice shell, survive Frost Slam, and evade erupting icicles.", tell: "Ice armor and ground warning circles", tier: 10, introductionNight: 10, selectionWeight: 0, spawnWeight: 0, threat: 42, xp: 24, base: { health: 900, speed: 50, damage: 20, structureDamage: 38, attackRate: 1.9, radius: 68 }, caps: { perWave: 1, simultaneous: 1 }, assets: { portrait: "enemies/frost-warden", body: "enemies/frost-warden", hand: "gameplay/enemies/basic/hand" }, audio: { attack: "zombie-attack", death: "boss-death" }, targeting: { mode: "flag", detectionRadius: 9999, attackRange: 0, lockSeconds: 99 }, movement: { avoidStructures: false, obstacleFallback: true, preferredRange: 0, meleeSpikes: true }, attack: { mode: "boss", chargeSeconds: 0.294 }, death: { mode: "none" }, rosterEligible: false, campaignTierIds: ["snowy"], countsForKills: true }),
};
