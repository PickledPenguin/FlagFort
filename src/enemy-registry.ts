...
export interface EnemyDefinition {
  ...
  targeting: {
    ...
    innerRadius?: number;
    lockSeconds: number;
    priorities?: readonly ("player" | "flag" | StructureKind)[];
  };
  movement: {
